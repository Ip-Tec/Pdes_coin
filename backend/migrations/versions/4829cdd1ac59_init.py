...
Revision ID: 4829cdd1ac59
Revises: 
Create Date: 2025-01-20 16:55:05.634227
...
def upgrade():
    ...
    sa.Column('referral_percentage', sa.Float(), nullable=False),
    ...
    sa.Column('crypto_address', sa.String(length=20), nullable=True),
    sa.Column('transaction_type', sa.String(length=20), nullable=False),
    sa.Column('transaction_completed', sa.Boolean(), nullable=True),
    sa.Column('created_at', sa.DateTime(), nullable=True),
    sa.Column('updated_at', sa.DateTime(), nullable=True),
    sa.ForeignKeyConstraint(['confirm_by'], ['user.id'], ),
    sa.ForeignKeyConstraint(['user_id'], ['user.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
