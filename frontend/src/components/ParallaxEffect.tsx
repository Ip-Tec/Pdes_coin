...
const ParallaxEffect: React.FC = () => {
  return (
    <div>
      ...
      >
        <div className="h-full flex items-center relative justify-center bg-black bg-opacity-50">
          <h1 className="text-4xl font-bold text-white text-center">
            The Future of Cryptocurrency
          </h1>
          <img src={logo} alt="Pdes" className="w-60 absolute bottom-[10%] md:bottom-[5%]" />
        </div>
      </section>
